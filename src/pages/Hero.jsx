      ...
      <section className="overflow-hidden rounded-[2rem] border border-[#fafad2] bg-gradient-to-br from-[#fff7f2] via-white to-[#fafad2] shadow-[0_20px_60px_-20px_rgb(218,145,0)]">
        <div className="flex flex-col lg:flex-row items-center gap-8 p-6 sm:p-8 lg:p-12">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <p className="inline-flex rounded-full bg-[#fafad2] px-3 py-1 text-sm font-semibold text-[#fcc200]">
              Luxury beauty, redefined
            </p>
            <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-[#2f2a29]">
              Where <span className="text-[#fcc200]">glow</span> meets confidence.
            </h1>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <a
                href="#services"
                className="rounded-full border border-[#fcc200] px-6 py-3 text-sm font-semibold text-[#fcc200] transition hover:bg-[#fafad2]"
              >
                Explore services
              </a>
            </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative mx-auto w-full max-w-120">
              <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-tr from-[#fcc200] to-[#fafad2] blur-2xl opacity-70"></div>
